 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".foods__items")) {
                const slider = new Swiper(".foods__items", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".foods__arrow_prev",
                        nextEl: ".foods__arrow_next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 1,
                ...
                const filterBtns = document.querySelectorAll(".foods__button");
                filterBtns.forEach((function(btn) {
                    btn.addEventListener("click", (function() {
                        ...
                        const filterCards = document.querySelectorAll(".item-food");
                        const filteredSlides = [];
                        filterCards.forEach((function(card, index) {
        ...
        function animationSection() {
            ...
            const observer = new IntersectionObserver((entries => {
                entries.forEach((entry => {
                    const animItemsInSection = entry.target.querySelectorAll(".animation");
                    animItemsInSection.forEach((animItem => {
                        const shouldAddActiveClass = entry.isIntersecting || animItem.classList.contains("anim-no-hide");
                        animItem.classList.toggle("active", shouldAddActiveClass);
                    }));
                }));
            }), observerOptions);
            document.querySelectorAll("[data-fp-section]").forEach((node => {
